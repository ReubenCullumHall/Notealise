...
**Status (2026-08-30): this brief is fully answered and is now history.** The fonts half shipped
2026-08-17 (research questions 2 and 3); page looks and tints shipped 2026-08-30 (questions 1, 4
and 5). `docs/feature-tabs-spaces.md`'s "Fonts" and "Page looks and tints" sections are the live
documentation and supersede everything below — including §5's "no precedent yet" and its
description of an inert collection shell, both of which are now out of date. Keep this file for
the framing and the constraints it set; don't take its status claims as current.
