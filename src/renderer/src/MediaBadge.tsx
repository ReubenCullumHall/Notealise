...
export function MediaTag({ hasOrigin }: { hasOrigin: boolean }): React.JSX.Element {
  return (
    <span className="flex shrink-0 items-center gap-1">
      <span className="rounded bg-brand-500/15 px-1.5 py-px text-[10px] font-semibold uppercase tracking-wide text-brand-600">
        Media
      </span>
      <span
        data-tip={
        ...
        className="flex h-3.5 w-3.5 items-center justify-center text-ink-300 transition-colors hover:text-ink-900"
      >
