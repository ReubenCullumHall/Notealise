 ...
 *  enough: the Intel build running on Apple silicon under Rosetta (someone
 *  picked the wrong Mac on the download page) reports x64, and would go on
 *  choosing the Intel build forever. Asking about the translation as well moves
 *  such an install onto the native build at its next update. */
