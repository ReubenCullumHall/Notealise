...
const api: VaultApi = {
  ...
  writeAsset: (dir, filename, data) => ipcRenderer.invoke(CH.writeAsset, dir, filename, data),
  pickAttachment: (dir) => ipcRenderer.invoke(CH.pickAttachment, dir),
  ...
  removeFont: (id) => ipcRenderer.invoke(CH.removeFont, id),
  ...
  trashEntries: (paths, origins) => ipcRenderer.invoke(CH.trashEntries, paths, origins),
  ...
  revealUpdate: () => ipcRenderer.invoke(CH.revealUpdate),
  ...
  setOnboardingStep: (step) => ipcRenderer.invoke(CH.setOnboardingStep, step),
  revealInFolder: (p) => ipcRenderer.invoke(CH.revealInFolder, p),
  bootInfo: () => ipcRenderer.invoke(CH.bootInfo),
  resetOnboardingTestVault: () => ipcRenderer.invoke(CH.resetOnboardingTestVault),
  importFormats: () => ipcRenderer.invoke(CH.importFormats),
  importPickSource: (format, mode) => ipcRenderer.invoke(CH.importPickSource, format, mode),
